    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white overflow-x-hidden">
      ...
      <nav className="relative z-50 flex items-center justify-between px-5 md:px-12 lg:px-20 py-5 border-b border-white/[0.06]">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/sign-up"
            className="px-6 py-2.5 bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-white rounded-xl text-sm font-semibold transition-all duration-300 shadow-lg shadow-violet-900/25 hover:scale-[1.02]"
          >
            Get Started Free
          </Link>
        </div>
      ...
      <section className="relative z-10 flex flex-col items-center justify-center text-center px-5 py-24 md:py-36">
        ...
        <p className="mt-8 text-slate-400 text-lg md:text-xl leading-relaxed max-w-xl">
          Track every application, monitor your pipeline, and land your dream
          job faster with our smart job tracker.
        </p>

        <div className="flex flex-col sm:flex-row items-center gap-4 mt-10">
          <Link
            href="/sign-up"
            className="px-8 py-4 bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-white rounded-2xl font-semibold text-sm transition-all duration-300 shadow-xl shadow-violet-900/30 hover:scale-[1.03]"
          >
            Start Tracking Free →
          </Link>
          <Link
            href="/sign-in"
            className="px-8 py-4 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.08] rounded-2xl font-semibold text-sm transition-all duration-300"
          >
            Sign In
          </Link>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-5 grid grid-cols-2 md:flex md:flex-wrap items-center justify-center gap-8 md:gap-20">
          {[
            ...
            <div key={i} className="text-center">
              <div className="text-2xl md:text-4xl font-extrabold bg-gradient-to-r from-violet-400 to-indigo-400 bg-clip-text text-transparent">
                {stat.number}
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-500 text-base max-w-md mx-auto">
              Built for developers and professionals who want to stay organized
            ...
            {[
              {
                ...
                desc: "Add every job you apply to with company, role, date, and job URL.",
              ...
              },
              {
                ...
                desc: "Move applications through Saved → Applied → Interview → Offer → Rejected.",
              ...
              },
              {
                ...
                desc: "See your application stats, success rate, and pipeline at a glance.",
              ...
              },
              {
                icon: "📝",
                title: "Notes & Details",
                desc: "Add salary, location, resume used, and personal notes for each job.",
                border: "hover:border-fuchsia-500/30",
                glow: "group-hover:bg-fuchsia-500/10",
              },
              {
                icon: "🔗",
                title: "Linked to ResumeCraft",
                desc: "Track which resume you used for each application.",
              ...
              },
              {
                ...
                desc: "Beautiful dark and light themes that save your preference.",
              ...
              >
                <div
                  className={`absolute inset-0 ${feature.glow} transition-colors duration-500 rounded-2xl`}
                />
        ...
        <div className="max-w-3xl mx-auto relative">
          ...
          <div className="relative">
            ...
            <p className="text-slate-400 text-lg mb-10 max-w-md mx-auto">
              Join thousands of job seekers who use JobTracker to stay organized
              and land their dream jobs.
            </p>
            <Link
              href="/sign-up"
              className="inline-flex items-center gap-2 px-10 py-4 bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-white rounded-2xl font-semibold transition-all duration-300 shadow-2xl shadow-violet-900/30 hover:scale-[1.03]"
            >
